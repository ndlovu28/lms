	...
	<div class="deznav">
		<div class="deznav-scroll">
			<ul class="nav menu-tabs">
				@if(Auth::user()->role->name == "su")
				<li class="nav-item">
					<a class="nav-link active ai-icon" data-bs-toggle="tab" href="#su-dashboard">
				...
				@elseif(Auth::user()->role->name == "admin")
				<li class="nav-item">
					<a class="nav-link active ai-icon" data-bs-toggle="tab" href="#admin-dashboard">
						<svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
					</a>
				</li>
				<li class="nav-item">
				...
				@elseif(Auth::user()->role->name == "tutor")
				<li class="nav-item">
					<a class="nav-link active ai-icon" data-bs-toggle="tab" href="#tutor-dashboard">
						<svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
					</a>
				</li>
				<li class="nav-item">
				...
				@else
				<li class="nav-item">
					<a class="nav-link active ai-icon" data-bs-toggle="tab" href="#sutudent-dash">
						<svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
					</a>
				</li>
				@endif
